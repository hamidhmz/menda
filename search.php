...
<!-- header container end here -->
	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="row rightbar">
				...
				$query="select * from product where name like '%$search_text%' order by id DESC " ;
							...
							<div class="image">
								...
								<?php 
									...
									<div class="button-group grrid">
										...
										<button type="button" data-toggle="tooltip" title="Add to Cart"><i class="fa fa-shopping-basket" aria-hidden="true"></i></button>

										<button type="button" data-toggle="tooltip" title="View this product"><i class="fa fa-eye"></i></button>

										<button type="button" data-toggle="tooltip" title="Add to wishlist"><i class="fa fa-heart"></i></button>
	...
	<?php
				...
				if($a == ''){
					...
					?>
					<p style="margin: 100px;color: red;font-size: 18px">هیچ محصولی یافت نشد</p>
