...
<!-- Mirrored from wptheme.co.in/menda-html/gallery1.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 24 Jan 2017 16:01:02 GMT -->
<head>
		...
		<div class="row gallery1">
			...
			<div id="content" class="col-sm-12">
				...
				<ul class="list-unstyled">
					...
					$query="select * from pic where action=1 order by id desc  ";
					$queryRun=$db->query($query);
					while($fetch=$queryRun->fetch_assoc()){
						?>
					<li class="item col-lg-3 col-md-3 col-sm-6 col-xs-12" style=" height: 240px !important;">
...
<!-- Mirrored from wptheme.co.in/menda-html/gallery1.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 24 Jan 2017 16:02:54 GMT -->
</html>