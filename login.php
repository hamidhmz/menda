...
if(isset($_POST['login'])) {
	$email=$_POST['email'];
	$pass= md5($_POST["pass"]);
	$query="SELECT * FROM user WHERE  email = '$email' and pass = '$pass' and action=1"; 
	...
	if(is_array($fetch)) {
		...
		$message = "آدرس ایمیل و یا رمز عبور خود را اشتباه وارد کرده اید !!!";
	}
}
...
?>
	...
	if(isset($_POST['submit'])) {
		...
		$query3="SELECT * FROM user WHERE  email = '$email'  and action=1"; 
		$query3Run=$db->query($query3); 
		$fetch3=$query3Run->fetch_assoc();
		if(is_array($fetch3)) {
		$message = "فبلا ثبت نام کرده اید !!!";
	}else{
		
		if ($mashhad == $_POST['city']) { $city=1; }elseif ($_POST['city'] == 'تهران') { $city = 2; }
		else{ $city = 3; }

		$query1="insert into user (id,name,pass,love,pic,id_prudoct,tel,companyname,email,adress,city,lastname,action) values ('','$name','$pass','','','','$tel','$companyname','$email','$adress','$city','$lname',$action)";
	...
	<div class="bread">
		...
		<div class="container">
			...
			<ul class="breadcrumb">
				...
				<li><a href="login.php">ورود و ثبت نام</a></li>  
		...
		<div class="row">
			...
			<div id="content" class="col-sm-12 checkout">
				...
				<ul class="list-unstyled code-login">
					...
					<li><h3>برای خرید یا فروش محصولات ابتدا باید ثبت نام کنید.</h3></li>
					<li></li>
				</ul>

				

				<div class="col-sm-6" style="border-right: 3px solid #ddd">
					<form class="" method="post" action="#">
						<h2><span>ثبت نام در سایت</span></h2>
						...
						<div class="form-group">
							...
							<div class="col-sm-12">
								...
								<label>نام تولیدی</label>

								<input type="text" class="form-control" id="input-companyname" value="" name="companyname">
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								...
								<input type="text" placeholder="ایمیل شما همان نام کاربری شما خواهد بود" class="form-control" id="input-email" value="" name="email">
							...
							<div class="col-sm-6">
								...
								<input type="text" class="form-control" id="input-telephone" value="" name="tel">
						...
						<div class="form-group">
							...
							<div class="col-sm-12">
								...
								<select class="form-control selectpicker" id="input-country" name="city">
						...
						<div class="form-group">
							...
							<div class="col-sm-12">
								...
								<input type="password" class="form-control" id="input-postcode" value="" name="pass">
						...
						<input type="submit" name="submit" style="margin: 20px auto" class="btn btn-success btn-lg" value="تکمیل ثبت نام">
					</form>
				</div>
						...
						<form class="" method="post" action="#">
							...
							<div class="form-group">
								...
								<div class="col-sm-12">
									...
									<input type="email" required class="form-control" id="input-name" value="" name="email">

								</div>

								<div class="col-sm-12">

									<label>پسورد<span class="req">*</span></label>

									<input type="password" required class="form-control" id="input-lastname" value="" name="pass">

								</div>

							</div>
							<input type="submit" style="margin: 20px auto" name="login" class="btn btn-info btn-lg" value="ورود">
